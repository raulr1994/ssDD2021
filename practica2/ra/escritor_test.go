...
func TestWritter(t *testing.T){
    	...
    	nNodes := 3 //Nº total de nodos en la red
		...
		rai.Logger.LogLocalEvent("Entering to SC by Writter "  + strconv.Itoa(rai.me) +  "and Writting ", govec.GetDefaultLogOptions())
		...
		rai.Logger.LogLocalEvent("Exiting from SC by Writter " + strconv.Itoa(rai.me) + " and free the SC " + strconv.Itoa(rai.me), govec.GetDefaultLogOptions())
