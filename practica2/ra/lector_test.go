...
func TestReader(t *testing.T){
		...
		rai.Logger.LogLocalEvent("Entering to SC by Lector " + strconv.Itoa(rai.me) + and reading, govec.GetDefaultLogOptions())
		...
		rai.Logger.LogLocalEvent("Exiting from SC by Lector" + strconv.Itoa(rai.me) + "and free the SC " + strconv.Itoa(rai.me), govec.GetDefaultLogOptions())
